...
public class FontCache {
    ...
    private FontCache() {
        AssetManager am = StudyApplication.getInstance().getResources().getAssets();
        String fileList[];
        try {
    ...
    public Typeface get(String fontName) {
        ...
        if (cache.containsKey(fontName)) {
            ...
            Typeface typeface = Typeface.createFromAsset(StudyApplication.getInstance().getAssets(), FONT_DIR + "/" + fontFilename);
